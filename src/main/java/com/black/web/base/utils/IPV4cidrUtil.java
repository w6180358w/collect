 ...
 *
 */
public class IPV4cidrUtil {
	int baseIPnumeric;
	int netmaskNumeric;
	private Integer banettestseIPnumeric;
	 ...
	 * @param netmask
	 */
	public IPV4cidrUtil(String symbolicIP, String netmask) throws NumberFormatException {
		/* IP */
	 ...
	 */
	public IPV4cidrUtil(String IPinCIDRFormat) throws NumberFormatException {
	...
	public List<String> getAvailableIPs(Integer numberofIPs) {
		...
		//for (int i = 0; i <= (numberOfIPs) && i <= numberofIPs; i++) {//全IP段 包括网关及广播地址
	...
	public boolean contains(IPV4cidrUtil child) {
		Integer subnetID = child.banettestseIPnumeric;
...
//		 */
//
//		IPV4cidrUtil ipv4 = new IPV4cidrUtil("10.10.101.6/29");
//		System.out.println("IP:"+ipv4.getIP());
//		System.out.println("Netmask:"+ipv4.getNetmask());
//		System.out.println("CIDR:"+ipv4.getCIDR());
//		System.out.println("BroadcastAddress:"+ipv4.getBroadcastAddress());
//		System.out.println("HostAddress:"+ipv4.getHostAddressRange());
//
//		int count = ipv4.getNumberOfHosts().intValue();
//		System.out.println("["+count+"]");
//		int c = 1;
//		for (String ip : ipv4.getAvailableIPs(count)) {
...
////	    list1.addAll(list2);
//		//ipv4-X.addAll(ipv4-Y);//并
//		//ipv4.getAvailableIPs(count).removeAll(XXX_list);//差
//		
//		List<String> availableIPs = ipv4.getAvailableIPs(ipv4.getNumberOfHosts().intValue());
//		System.out.println(availableIPs.indexOf("10.10.101.7"));
//		
//		System.out.println(StringUtils.isIpV4Address("1.1.1.300"));
//	}
}
